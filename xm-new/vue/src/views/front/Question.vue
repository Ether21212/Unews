<template>
  <div style="width: 60%; margin: 50px auto">
    <div style="display: flex; align-items: flex-start; grid-gap: 30px">
      ...
      <div style="width: 300px">
        <div style="display: flex; margin-bottom: 10px">
          <img src="@/assets/imgs/question.png" alt="" style="width: 40px; height: 40px; margin-top: 5px; margin-right: 5px">
          <span style="font-size: 20px ;margin-left: 10px ;margin-top: 14px">等你回答</span>
        </div>
        <div>
          <div class="card" v-for="item in noAnswerList" :key="item.id" style="margin-bottom: 10px">
            ...
            <div style="color: #888; display: flex">
              ...
              <el-button type="primary" size="mini" icon="el-icon-edit" @click="$router.push('/front/questionDetail?id=' + item.id)">写回答</el-button>
            </div>
          </div>
        </div>
      </div>
...
/* 调整答案卡片的显示效果，使其更加统一和美观 */
.card {
  background-color: #f9f9f9; /* 轻微调整卡片背景色以区分主体 */
  border-radius: 5px;
  padding: 15px;
  box-shadow: 0 1px 4px rgba(0,0,0,0.5); /* 轻微阴影效果增加层次感 */
}
</style>